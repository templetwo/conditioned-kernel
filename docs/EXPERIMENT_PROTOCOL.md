...
|---|---|---|
| C0 | Bare | User input only |
| C1 | Budget-matched bare | Same approximate token budget as full packet, unstructured or randomly ordered state dump |
...
C1 is mandatory. Without it, “substrate gain” confounds topology with prompt length.
