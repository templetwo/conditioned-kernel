...
PACKET = {
    "packet_id": "pkt_r",
    "user_input": "Name one open research thread and why it matters.",
    "state_digest": {
        "goal": (
...
def test_repair_plan_has_actionable_hints():
    raw = (
        '{"answer":"hello only about threads",'
        '"evidence_used":["invented"],'
...
def test_junk_thread_touch_ignored():
    raw = (
        '{"answer":"thread_min_model matters for edge substrate sizing on Jetson local models.",'
